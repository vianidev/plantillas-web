/* ============================================
   ...
   animado de estadísticas, validación de
...
function initHeaderScroll() {
  ...
  const actualizar = () => {
    if (window.scrollY > 10) {
      header.style.borderBottomColor = 'rgba(201, 162, 39, 0.35)';
    } else {
...
function initFormularioContacto() {
  ...
  form.addEventListener('submit', (evento) => {
    ...
    if (!formularioValido) {
      ...
      status.style.color = '#D68374';
      return;
    }

    // Simulación de envío (no hay backend conectado todavía)
    status.style.color = '';
